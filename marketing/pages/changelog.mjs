...
const RELEASES = [
  [
    "September 24, 2026",
    "A simpler toolbar, one assignment for every section, links that work, a menu for everything on a page, a page comparing Notesanity with the tools you already know, and what the Free plan will include after the beta.",
    [
