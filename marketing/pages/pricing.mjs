  ...
  <div class="wrap narrow">
    ...
    <p class="lede">
      ${BETA_FREE
        ...
        : "Keep Classroom, keep your files, keep your gradebook. Notesanity replaces the printing, not your stack. Start free, and go Pro when you want last year's work to pay off again: unlimited notebooks and the page library. Schools buy by the department or the building, on an invoice."}
    </p>
  </div>
</section>
